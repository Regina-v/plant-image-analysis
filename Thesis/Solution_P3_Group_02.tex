...
%TODO *** COMMENT Regina: I would leave out the middle column since this is hidden to the user and not important for the user. **
\begin{table}[htbp]
	\centering
...
\begin{figure}
	...
	\qquad
	\subfloat[A2 Dataset]{\includegraphics[scale=.6]{pic/A2-truth}}
	\caption{XXX}
	\label{fig:truth}
\end{figure}
